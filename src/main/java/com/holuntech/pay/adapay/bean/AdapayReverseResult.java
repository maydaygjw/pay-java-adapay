...
/**
 * Adapay 支付撤销结果（延时分账撤销）。
 *
 * @author egan
 */
public class AdapayReverseResult implements Serializable {
     ...
     * 已撤销金额
     */
    private BigDecimal reversedAmt;
    ...
    public AdapayReverseResult() {
    }

    public AdapayReverseResult(Map<String, Object> result) {
        this.id = getString(result, "id");
        this.paymentId = getString(result, "payment_id");
        this.orderNo = getString(result, "order_no");
        this.reverseAmt = toBigDecimal(getString(result, "reverse_amt"));
        this.reversedAmt = toBigDecimal(getString(result, "reversed_amt"));
    ...
    public void setReverseAmtString(String reverseAmt) {
        this.reverseAmt = toBigDecimal(reverseAmt);
    }

    public BigDecimal getReversedAmt() {
        return reversedAmt;
    }

    public void setReversedAmt(BigDecimal reversedAmt) {
        this.reversedAmt = reversedAmt;
    }

    public void setReversedAmtString(String reversedAmt) {
        this.reversedAmt = toBigDecimal(reversedAmt);
    }
